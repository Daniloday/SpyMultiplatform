    ...
    Box(
        ...
        Card(
            ...
            Column(
                ...
                Text(text = stringResource(Res.string.spy_premium), textAlign = TextAlign.Center, style = AppTheme.types.h30)
                AppDivider(modifier = Modifier.fillMaxWidth(0.9f), color = AppTheme.colors.primary)
                ...
                Text(text = stringResource(Res.string.thanks_for_purchase), fontWeight = FontWeight.ExtraBold, textAlign = TextAlign.Center, style = AppTheme.types.h30)
                Text(text = stringResource(Res.string.enjoy_game), fontWeight = FontWeight.ExtraBold, textAlign = TextAlign.Center, style = AppTheme.types.h30)
            }
        }
    }
    PrimaryButton(modifier = Modifier.padding(bottom = 16.dp), text = stringResource(Res.string.play), onClick = onPlay)
}
...
private fun ColumnScope.BuyPremiumContent(
    ...
    SecondaryButton(Modifier.padding(bottom = 16.dp), text = stringResource(Res.string.restore_purchases), onClick = onRestore)
